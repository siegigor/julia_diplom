...
$client="8efa22c0f2c392687c4daa29feeb75c0e41745c4"; // Your client secret code.
...
$lang="JAVA"; // the language of the source code. eg C++ C++11 C C# Python
$input="5 10"; // the input values to run this code on. (Optional)
$hack = new HackApi;
